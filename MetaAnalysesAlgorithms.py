...
def run_all_MA_algorithms(results_dir, matrix_betas):
     ...
     seaborn.heatmap(matrix_p_generated, vmin=0, cmap='Reds_r', ax=axs[0], cbar_kws={'shrink': 0.5})
     axs[0].title.set_text("generated p values")
     axs[0].set_ylabel("K teams")
     axs[0].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_p_generated, vmin=0, vmax=0.06, cmap='Reds_r', mask=matrix_p_generated > 0.05, ax=axs[1],cbar_kws={'shrink': 0.5})
     axs[1].title.set_text("significant p values")
     axs[1].set_ylabel("K teams")
     axs[1].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_p_generated.mean(axis=0).reshape(1, -1), cmap='Reds_r', square=True, ax=axs[2],cbar_kws={'shrink': 0.5})
     axs[2].title.set_text("Mean p values")
     axs[2].set_ylabel("p")
     axs[2].set_xlabel('J Voxels')
     seaborn.heatmap(vector_fisher.reshape(1, -1), cmap='Reds', square=True, mask=vector_fisher.reshape(1, -1) < 31.410, ax=axs[3],cbar_kws={'shrink': 0.5})
     axs[3].title.set_text("Significant Fisher X2 values >= 31.41")
     axs[3].set_ylabel("X2")
     ...
     # K=10 thus Chi2 threshold at 2k(20) => 31.41
     f, axs = plt.subplots(4, figsize=(5, 8))
     seaborn.heatmap(matrix_p, vmin=0, cmap='Reds_r', ax=axs[0], cbar_kws={'shrink': 0.5})
     axs[0].title.set_text("p values (from standardized Betas)")
     axs[0].set_ylabel("K teams")
     axs[0].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_p, vmin=0, vmax=0.06, cmap='Reds_r', mask=matrix_p > 0.05, ax=axs[1],cbar_kws={'shrink': 0.5})
     axs[1].title.set_text("significant p values")
     axs[1].set_ylabel("K teams")
     axs[1].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_p.mean(axis=0).reshape(1, -1), cmap='Reds_r', square=True, ax=axs[2],cbar_kws={'shrink': 0.5})
     axs[2].title.set_text("Mean p values")
     axs[2].set_ylabel("p")
     axs[2].set_xlabel('J Voxels')
     seaborn.heatmap(vector_fisher.reshape(1, -1), cmap='Reds', square=True, mask=vector_fisher.reshape(1, -1) < 31.410, ax=axs[3],cbar_kws={'shrink': 0.5})
     ...
     f, axs = plt.subplots(4, figsize=(5, 8))
     seaborn.heatmap(matrix_z, center=0, cmap='coolwarm', ax=axs[0],cbar_kws={'shrink': 0.5})
     axs[0].title.set_text("Z values (Standardized Betas)")
     axs[0].set_ylabel("K teams")
     axs[0].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_z.mean(axis=0).reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[1],cbar_kws={'shrink': 0.5})
     axs[1].title.set_text("Mean Z values")
     axs[1].set_ylabel("Z")
     axs[1].set_xlabel('J Voxels')
     seaborn.heatmap(vector_stouffer.reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[2],cbar_kws={'shrink': 0.5})
     axs[2].title.set_text("Stouffer Z values")
     axs[2].set_ylabel("Z")
     axs[2].set_xlabel('J Voxels')
     seaborn.heatmap(stouffer_p.reshape(1, -1), vmin=0, vmax=0.06, cmap='Reds_r', square=True, mask=stouffer_p.reshape(1, -1) > 0.05, ax=axs[3],cbar_kws={'shrink': 0.5})
     axs[3].title.set_text("significant p values")
     axs[3].set_ylabel("p")
     axs[3].set_xlabel('J Voxels')
     ...
     seaborn.heatmap(matrix_z.T, center=0, cmap='coolwarm', ax=axs[0],cbar_kws={'shrink': 0.5})
     ...
     # a = Z_star_k.T
     # a.sort()
     seaborn.heatmap(Z_star_k.T, center=0, cmap='coolwarm', ax=axs[1],cbar_kws={'shrink': 0.5})
     axs[1].title.set_text("Standardized Z values")
     axs[1].set_ylabel("K teams")
     axs[1].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_z.mean(axis=1).reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[2],cbar_kws={'shrink': 0.5})
     axs[2].title.set_text("Mean Z values")
     axs[2].set_ylabel("Z")
     axs[2].set_xlabel('J Voxels')
     seaborn.heatmap(Z_star_consensus.reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[3],cbar_kws={'shrink': 0.5})
     axs[3].title.set_text("T values")
     axs[3].set_ylabel("T")
     axs[3].set_xlabel('J Voxels')
     seaborn.heatmap(p.reshape(1, -1), vmin=0, cmap='Reds_r', square=True, mask=p.reshape(1, -1) > 0.05, ax=axs[4],cbar_kws={'shrink': 0.5})
     axs[4].title.set_text("Significant p values")
     axs[4].set_ylabel("p")
     ...
     f, axs = plt.subplots(4, figsize=(5, 8))
     seaborn.heatmap(matrix_betas, center=0, cmap='coolwarm', ax=axs[0],cbar_kws={'shrink': 0.5})
     axs[0].title.set_text("Original Z values")
     axs[0].set_ylabel("K teams")
     axs[0].set_xlabel('J Voxels')
     seaborn.heatmap(matrix_betas.mean(axis=0).reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[1],cbar_kws={'shrink': 0.5})
     axs[1].title.set_text("Mean Z values")
     axs[1].set_ylabel("Z")
     axs[1].set_xlabel('J Voxels')
     seaborn.heatmap(T.reshape(1, -1), center=0, cmap='coolwarm', square=True, ax=axs[2],cbar_kws={'shrink': 0.5})
     axs[2].title.set_text("T values")
     axs[2].set_ylabel("T")
     axs[2].set_xlabel('J Voxels')
     seaborn.heatmap(p.reshape(1, -1), vmin=0, cmap='Reds_r', square=True, mask=p.reshape(1, -1) > 0.05, ax=axs[3],cbar_kws={'shrink': 0.5})
     axs[3].title.set_text("Significant p values")
     axs[3].set_ylabel("p")
     axs[3].set_xlabel('J Voxels')
